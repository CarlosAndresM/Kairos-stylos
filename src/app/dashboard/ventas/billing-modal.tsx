...
export function BillingModal({
  ...
  */
  ...
  const handleGarantiaSuccess = (data: { detalleOriginalId: number, tecnicoOriginalId: number, factura?: string, servicio?: string, tecnicoOriginalNombre?: string }) => {
    ...
    const newPayments = [...currentPayments, { 
      ...
      meta: {
        ...
        tecnicoOriginalNombre: data.tecnicoOriginalNombre
      }
    }]
